...
parser.add_argument('--dirpath', type=str, default='images/')
...
parser.add_argument('--showiter', type=int, default=50)
parser.add_argument('--max_iter_hr', type=int, default=200)
opt = parser.parse_args()

image_dir = opt.dirpath
max_iter = opt.maxiter
show_iter = opt.showiter
img_size = 512
...
img_names = [opt.style_image, opt.content_image]
